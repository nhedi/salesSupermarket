...
public class SalesItemDisplay implements SalesObserver {
     ...
     */
    @Override
	public void newItem(SalesLineItem lineItems) throws NoneExistingItemIdException {
	 ...
	 * @throws NoneExistingItemIdException if the search item Id does not exist in the product catalog.
	 */
	private void addNewItem(SalesLineItem lineItems) throws NoneExistingItemIdException {
	 ...
	 * @throws NoneExistingItemIdException if the search item Id does not exist in the product catalog.
	 */
	public void printCurrentState(List<SalesLineItem> noOfItemsRegistered) throws NoneExistingItemIdException { 
